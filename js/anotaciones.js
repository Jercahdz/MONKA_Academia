...
// Datos quemados
const jugadores = [
    { id: 1, nombre: "Juan", apellidos: "Pérez", edad: 15, goles: 5, categoria: "U-15", tipoGol: "Tiro libre", pieHabil: "Derecho", posicion: "Delantero", dorsal: 9 },
    { id: 2, nombre: "María", apellidos: "González", edad: 17, goles: 7, categoria: "U-17", tipoGol: "Cabeza", pieHabil: "Izquierdo", posicion: "Centrocampista", dorsal: 8 },
    { id: 3, nombre: "Carlos", apellidos: "Rodríguez", edad: 14, goles: 4, categoria: "U-15", tipoGol: "Penalti", pieHabil: "Derecho", posicion: "Defensor", dorsal: 3 },
    { id: 4, nombre: "Ana", apellidos: "Martínez", edad: 16, goles: 6, categoria: "U-17", tipoGol: "Tiro libre", pieHabil: "Derecho", posicion: "Delantero", dorsal: 11 },
    { id: 5, nombre: "Luis", apellidos: "Sánchez", edad: 21, goles: 3, categoria: "U-20", tipoGol: "Cabeza", pieHabil: "Izquierdo", posicion: "Portero", dorsal: 1 }
];
    ...
    jugadoresFiltrados.forEach(jugador => {
        ...
        fila.innerHTML = `
            ...
            <td>
                ...
                <button onclick="añadirGol(${jugador.id})">Añadir Gol</button>
            </td>
        `;
    });
}
...
function verDetalles(id) {
    ...
    infoJugador.innerHTML = `
        ...
        <p><strong>Tipo de Gol:</strong> ${jugador.tipoGol || 'No especificado'}</p>
...
function editarDatosAvanzados(id) {
    ...
    Tipo de Gol actual: ${jugador.tipoGol}
